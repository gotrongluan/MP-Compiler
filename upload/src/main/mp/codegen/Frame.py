...
class Frame():
    def __init__(self, name, returnType):
        ...
        self.currentLabel = 0
        self.currOpStackSize = 0                #current size of stack
        self.maxOpStackSize = 0                 #max size ever of stack --> limit stack
        self.currIndex = 0                      #
        self.maxIndex = 0                       #max index ever --> limit local
        self.startLabel = list()                #start label of scope of method
        self.endLabel = list()                  #end label of scope of method
    ...
    *   @return an integer representing the label.
    ...
    def getNewLabel(self):
        tmp = self.currentLabel                 #chi so label
